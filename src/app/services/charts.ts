    ...
    datasets: [
        {
            ...
            backgroundColor: [Colors.getColors().themeColor3_10, Colors.getColors().themeColor2_10, Colors.getColors().themeColor1_10],
            borderWidth: 2,
            data: [15, 25, 20],
        },
    ],
